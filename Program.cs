...
var connectionString = "Host=localhost;Port=5432;Database=nalakreditimachann;Username=postgres;Password=admin123";
...
try
{
    ...
    var query = @"
        ...
        WHERE table_name = 'savingcustomers'
    ...
    {
        var existsQuery = $"SELECT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'savingcustomers' AND column_name = '{col}')";
