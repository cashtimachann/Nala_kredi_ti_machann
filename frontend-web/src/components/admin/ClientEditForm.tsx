...
const ClientEditForm: React.FC<ClientEditFormProps> = ({ customer, onSubmit, onCancel }) => {
  ...
  documentType: identityDocumentTypeFromString(data.documentType),
        ...
        ...(isBusiness ? {
          ...
          transactionFrequency: data.transactionFrequency || undefined,
          accountPurpose: data.accountPurpose || undefined,
          referencePersonName: data.referencePerson || undefined, // Backend utilise referencePersonName
          referencePersonPhone: data.referencePersonPhone || undefined,
          maritalStatus: data.maritalStatus || undefined,
          spouseName: data.spouseName || undefined,
          numberOfDependents: data.numberOfDependents !== undefined && data.numberOfDependents !== '' ? data.numberOfDependents : undefined,
